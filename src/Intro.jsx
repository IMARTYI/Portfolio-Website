    ...
    return (
      <html lang="en" className="!scroll-smooth">
        <div lang="en" className="!scroll-smooth font-sans antialiased">
          ...
          <section>
            <div class="container mx-auto  py-36" id="section2">
              <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
                <div class="col-span-4 sm:col-span-3">
                  <div class="bg-green-600 bg-opacity-50 shadow rounded-lg p-6">
                    <div class="flex flex-col items-center">
                      <img
                        src="david2.jpg"
                        class="w-32 h-32 bg-green-300 rounded-full mb-4 shrink-0 top-0"
                      ></img>
                ...
                <div
                  class=" bg-green-600 bg-opacity-50 col-span-4 sm:col-span-9 rounded"
                  id="section1"
                >
                  <div class="bg-g shadow rounded-lg p-6">
                    <h2 class=" text-white text-xl font-bold mb-4">About Me</h2>
                    <p class="text-white mt-2">
                      I would like to welcome you to my website. My name is
                      David Martin and I am a Computer Science Student at Brock
                      University. I started my Promgramming journey at the age
                      of 18 during my final senior year of high school. I want
                      to contiue to learn about the vast realm of Computer
                      Science all while developing my practical coding skills.
                      Presented below are a number of projects I have worked on
                      over the years.
                    </p>
                    ...
                    <div class="mb-6">
                      <div class="flex justify-between">
                        ...
                        <p>
                          <span class="text-white-600 mr-2">
                            at ABC Company
                          </span>
                          <span class="text-white-600">2017 - 2019</span>
                        </p>
