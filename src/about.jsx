    ...
    <div className="">
      <div className="container mx-auto py-8 px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {/* Profile Section */}
          <div className="col-span-1 md:col-span-1 bg-green-600 bg-opacity-50 shadow-lg rounded-lg p-6">
          ...
          {/* About Me Section */}
          <div className="col-span-1 md:col-span-3 bg-green-600 bg-opacity-50 shadow-lg rounded-lg p-6">
