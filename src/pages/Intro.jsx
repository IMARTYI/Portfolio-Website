...
>
  <div className="container flex flex-col xl:flex-row items-center justify-center">
    {/* Text Section */}
    <div
      className="justify-center text-center xl:text-left xl:w-1/2 xl:pl-16 animate-fadeSlideIn"
    >
      ...
      <p className="text-gray-300 text-lg md:text-2xl px-3">
        I'm a Software Engineer passionate about exploring and
    ...
    <div
      ...
      style={{ animationDelay: "0.5s" }} /* Optional delay for staggered effect */
    >
      <img
